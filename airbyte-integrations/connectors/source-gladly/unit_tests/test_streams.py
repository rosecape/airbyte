...
import pytest
from source_gladly.source import GladlyStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GladlyStream, "path", "v0/example_endpoint")
    mocker.patch.object(GladlyStream, "primary_key", "test_primary_key")
    mocker.patch.object(GladlyStream, "__abstractmethods__", set())
