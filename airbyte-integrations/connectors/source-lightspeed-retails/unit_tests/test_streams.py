...
import pytest
from source_lightspeed.streams import LightspeedStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(LightspeedStream, "path", "v0/example_endpoint")
    mocker.patch.object(LightspeedStream, "primary_key", "test_primary_key")
    mocker.patch.object(LightspeedStream, "__abstractmethods__", set())
