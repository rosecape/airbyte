...
import pytest
from source_eventnroll.source import EventnrollStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(EventnrollStream, "path", "v0/example_endpoint")
    mocker.patch.object(EventnrollStream, "primary_key", "test_primary_key")
    mocker.patch.object(EventnrollStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = EventnrollStream()
