...
import pytest
from source_booker.source import BookerStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(BookerStream, "path", "v0/example_endpoint")
    mocker.patch.object(BookerStream, "primary_key", "test_primary_key")
    mocker.patch.object(BookerStream, "__abstractmethods__", set())
